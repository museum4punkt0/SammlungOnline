...
import MediaPlayerContext, { MediaPlayerContextData } from '../MediaPlayer/MediaPlayerContext';
import CollectionContext, { CollectionContextData } from '../Collection/CollectionContext';
import MediaPlayer from '../MediaPlayer/MediaPlayer';
import { useTranslation } from 'react-i18next';
import clsx from 'clsx';
import LazyImage from '../LazyLoading/LazyImage';
import HighlightButton from '../HighlightButton/HightlightButton';
...
function CollectionPlayerModule({
    interval,
    wrapperClasses = '',
    ...
    const [activeCollectionIndex, setActiveCollectionIndex] = useState<number | undefined>(
        collectionContext.selectedObjectIndex,
    );

    const debounceToggleControls = AwesomeDebouncePromise(setShowControls, 70, { key: (show) => show });
    ...
    }, [activeIndex, activeCollectionIndex, playerOpen, playerPlaying, collectionContext.selectedObjectIndex]);

    return (
        <div className={clsx(classes.contentWrapper, wrapperClasses, { [previewWrapperClasses]: !playerOpen })}>
            <MediaPlayerContext.Provider value={mediaPlayerContextData}>
                <MediaPlayer sliderClasses={mediaPlayerClasses} slideClasses={mediaPlayerClasses} zoom={true}>
                    <div className={classes.content}>
                        ...
                        <div
                            ...
                            style={{ backgroundImage: `url(${collectionContext.previewImageSlider})` }}
                        >
                        ...
                        <div className={classes.imageContainer}>
                            <CollectionContext.Consumer>
                                {(collectionContext): ReactElement => (
                                    <LazyImage src={collectionContext.previewImageSlider}>
                                        <img
...
export default CollectionPlayerModule;
