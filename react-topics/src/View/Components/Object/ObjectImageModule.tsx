...
import ObjectContext, { ObjectAttachment, ObjectContextData } from './ObjectContext';
        ...
        <React.Fragment>
            <div className={classes.container}>
                ...
                <div className={classes.imgContainer}>
                    ...
                    >
                        <Typography variant={'caption'} className={clsx(classes.pictureCredits)}>
                                        ...
                                        (attachment, index): ReactElement => (
                                            <LazyLoadComponent key={index}>
                                                <div
                                                    ...
                                                    onClick={(): void => objectContextData.previewClicked(attachment)}
                                                />
                                            </LazyLoadComponent>
                                        ),
                                    )}
