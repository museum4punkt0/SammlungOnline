...
import ObjectDescriptionGridRow from './ObjectDescriptionGridRow';
...
function ObjectDescriptionGrid({ config }: { config: Array<FieldVisibility> }): ReactElement {
    const object = useContext(ObjectContext).objectData;
    const { t } = useTranslation();
    const noDataAvailableText = t('object attribute fallback - no data available');
