...
import { SearchAttributeConditionFilterFields, SearchAttributeConditionFilterOperators } from '../../config';
    ...
    return (
        <>
            {conditionFields.map(({ id }, index) => {
                ...
                const { value, field, operator } = getValues<string, IVirtualSearchAttributeCondition>(baseName);
