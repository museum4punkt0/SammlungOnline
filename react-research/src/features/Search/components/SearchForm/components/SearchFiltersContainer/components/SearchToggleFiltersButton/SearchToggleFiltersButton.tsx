...
const SearchToggleFiltersButton: React.FC<ISearchToggleFiltersButtonProps> = (props) => {
    ...
    return (
        <div className={classes.advancedSearchContainer}>
            <Grid alignItems="flex-end" justify="space-between" direction="row" container spacing={0}>
                <Grid item container alignItems="center" justify="flex-start" lg={10} md={9} sm={8} xs={10}>
                ...
                {shouldShowFiltersCount && (
                    <Grid item container alignContent="center" justify="flex-end" lg={2} md={3} sm={4} xs={2}>
