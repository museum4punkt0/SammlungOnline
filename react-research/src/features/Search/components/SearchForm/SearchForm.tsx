...
import useDebouncedCallback from '../../../../core/hooks/use-debounce-callback.hook';
...
const SearchForm = React.memo(SearchFormComponent, (prevProps, nextProps) => {
    return prevProps.defaultValues !== nextProps.defaultValues && prevProps.onSubmit !== nextProps.onSubmit;
});
