...
const SwitchSearchResultView: React.FC<ISwitchSearchResultViewProps> = ({ fontSize, view }) => {
...
export const SearchPagination: React.FC<ISearchPaginationProps> = (props) => {
    const { view, viewToggle = true, onOffsetChange, offset, limit, total, onViewChange } = props;
    ...
    const iconLabel = view === ESearchResultView.GRID ? 'toggle list view' : 'toggle grid view';
