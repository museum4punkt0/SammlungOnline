...
interface IExhibitDescriptionAccordionProps {
    title: string;
    content: string;
    expanded?: boolean;
}

const ExhibitDescriptionAccordion: React.FC<IExhibitDescriptionAccordionProps> = (props) => {
...
export default ExhibitDescriptionAccordion;
