...
import ObjectContext, { ObjectContextData } from '../ObjectContext/ObjectContext';
...
function ObjectActions({
  ...
  const objectContextData: ObjectContextData =
    useContext<ObjectContextData>(ObjectContext);
