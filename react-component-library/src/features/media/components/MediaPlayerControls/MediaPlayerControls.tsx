...
import useStyles from '../MediaPlayerContext/mediaPlayerControls.jss';
...
export function MediaPlayerControls({
  ...
  const [imageContainerRef] = useState<RefObject<HTMLDivElement>>(
  ...
  return (
    ...
    >
        ...
        <div className={classes.maximizeButton}>
          <IconButton color={'inherit'} onClick={onFullscreenClick}>
            <FullscreenOutlinedIcon
              className={clsx({ [classes.hide]: fullscreen })}
            />
      ...
      {images && (
        <div
          id={MediaPlayerControlsPreviewImagesId}
          ref={imageContainerRef}
          className={classes.images}
        >
          <div className={classes.imagesSlider}>
            {images.map((value, index) => (
              <LazyLoadImage key={index} src={value}>
                <div
                  className={clsx(classes.image, {
                    [classes.activeImage]: imageIndex === index,
                  })}
                  key={index}
                  style={{
