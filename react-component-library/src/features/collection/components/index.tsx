...
export * from './CollectionModule/CollectionModule';
export { CollectionPlayerModule } from './CollectionPlayer/CollectionPlayerModule';
export { CollectionModule } from './CollectionModule/CollectionModule';
