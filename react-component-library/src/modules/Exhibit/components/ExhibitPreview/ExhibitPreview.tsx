...
import { IAttachment } from '../../../../core/models/attachment/attachment.model';
              ...
              attachments.map((attachment, i) => {
                return (
                  <div key={i} style={{ height: '86px' }}>
                    <LazyLoadImage width='86px' height='86px' src={attachment?.src} onClick={() => onChange && onChange(attachment)} />
                  </div>
                );
              })}
          </div>
