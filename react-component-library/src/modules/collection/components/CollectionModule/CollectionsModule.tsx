...
import CollectionsContext from '../../interfaces/CollectionsContext';
        ...
        <div id={'CollectionsModule'} className={clsx(classes.container, collectionModuleClasses)}>
          <Grid container={true} spacing={4} direction={'row'} justify={'center'} alignItems={'center'}>
            ...
            {collectionsContext.collections
              ...
              .map(({ id, previewImageCard, title, subtitle, collectionObjects }, index) => (
          ...
          <Collapse in={expanded} timeout='auto' unmountOnExit style={{ marginTop: '1rem' }}>
            <Grid
              style={{
                // maxWidth: '80rem',
                // maxHeight: '1600px',
          ...
          <Collapse in={!expanded && collectionsContext.collections.length > initialCards} timeout='auto' unmountOnExit>
