...
public class ParserUtils {
    ...
    public static String joinFqKey(
        ...
        boolean hasParentKey = StringUtils.hasLength(parentFqKey);
        boolean hasChildName = StringUtils.hasLength(childName);
        boolean hasChildId = !ObjectUtils.isEmpty(childId);
