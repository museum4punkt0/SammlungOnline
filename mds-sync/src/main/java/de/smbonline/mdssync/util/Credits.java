...
public final class Credits {
    ...
    public static final String STANDARD_LICENSE = "CC BY-NC-SA";

    public static boolean isRightsHolder(final @Nullable String licenseKey) {
        // by default, everything that is not creative-commons is considered a rights holder
        return licenseKey != null && !licenseKey.startsWith("CC");
    }

    public static String toCreditLine(final CreditsDTO credits) {
    ...
    private static String buildRightsHolderCreditsPart(final CreditsDTO credits) {
