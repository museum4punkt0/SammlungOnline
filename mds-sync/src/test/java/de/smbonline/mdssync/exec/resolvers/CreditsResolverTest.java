...
class CreditsResolverTest {
    ...
    @Test
    void testUseDefaultOwnerIfUnmapped() throws Exception {
        ModuleItem mediaItem = createMultimediaItem("Not-MIM");
        Credits credits = testObject().buildCredits(createObjectItem(false), mediaItem);
        assertThat(credits.getOwner()).isEqualTo("Staatliche Museen zu Berlin");
    }

    @Test
    void testUseOwnerSIMIfCollectionIsMIM() throws Exception {
        ModuleItem mediaItem = createMultimediaItem("MIM");
        Credits credits = testObject().buildCredits(createObjectItem(false), mediaItem);
        assertThat(credits.getOwner()).isEqualTo("Staatliches Institut für Musikforschung");
    }

    @Test
    void testBuildCreditsLineWithoutCollectionAndPhotographer() throws Exception {
    ...
    @Test
    void testBuildCreditsLineWithoutCollection() throws Exception {
    ...
    @Test
    void testBuildCreditsLineWithoutPhotographer() throws Exception {
    ...
    @Test
    void testBuildCreditsLine() throws Exception {
    ...
    @Test
    void testBuildCreditsLineWithMultiplePhotographers() throws Exception {
    ...
    @Test
    void testBuildCreditsLineWithMappedCollection() throws Exception {
    ...
    @Test
    void testBuildCreditsLineWithRightsHolder() throws Exception {
        ...
        Credits credits = testObject().buildCredits(objectItem, mediaItem);
    ...
    @Test
    void testBuildCreditsLineWithVGBildkunst() throws Exception {
        ModuleItem objectItem = createObjectItem(true);
