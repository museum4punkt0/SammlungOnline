...
function SliderModule({
    ...
    return (
        <div className={clsx(classes.sliderModule, sliderClasses)}>
            ...
            {arrows && (
                <IconButton className={classes.arrowBack} color="inherit" onClick={decrementActiveIndex}>
                    <ArrowBackIosIcon color={'inherit'} />
                </IconButton>
            )}
            {arrows && (
                <IconButton className={classes.arrowForward} color="inherit" onClick={incrementActiveIndex}>
