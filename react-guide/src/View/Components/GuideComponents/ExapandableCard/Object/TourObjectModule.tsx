...
// import { TourObjectData } from '../../interfaces/GuideContext';

import { LinkBuilder } from '../../../../../Util/LinkBuilder';
import { TourObjectData } from '../../../../../Services/Interfaces/GuideData';
...
function TourObjectModule({
    ...
    const generateRalatedTourLinks = () => {
        if (false) {
            const relatedTours: {
                link: void;
                title: string;
            ...
            <CollapsibleCard
                ...
                content={
                    ...
                    <ObjectContent
                        ...
                        relatedTours={generateRalatedTourLinks()}
                        mobile
                    />
                }
                footer={<CollapsibleCardHeader
                    title={name}
                // share
                // checkbox
                />}
