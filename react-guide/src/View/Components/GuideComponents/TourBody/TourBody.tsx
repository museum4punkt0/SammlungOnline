import { Grid, isWidthDown, isWidthUp, Theme, useMediaQuery, useTheme } from '@material-ui/core';
                    ...
                    return (
                        ...
                        >
                            {station.objects.map((object) => {
                                return (
                                    <TourObjectModule key={object.displayTitle} objectData={object} />
                                );
                            })}
                        </StationHeader>
                    );
                ...
                if (station.objects.length > 0) {
                    return (
                        ...
                        >
                            {station.objects.map((object) => {
                                return (
                                    <TourObjectModule mobile key={object.displayTitle} objectData={object} />
                                );
                            })}
                        </StationHeader>
                    );
