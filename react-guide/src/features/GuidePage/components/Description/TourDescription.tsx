...
function TourDescription({
  ...
  return (
    <div style={{ marginTop: '3rem', marginBottom: '1rem' }}>
      <TypoElement
        title={t('place') + ':'}
        content={location ? location : noDataAvailableText}
      />
      <TypoElement
        title={t('duration') + ':'}
        content={duration ? duration.toString() : noDataAvailableText}
      />
      <TypoElement
        title={t('objects') + ':'}
        content={
          objectsCount !== 0 ? objectsCount.toString() : noDataAvailableText
        }
      />
      <br />
